...
'''
input = u" this is jessica liang "
entity_list = ['jessica','liang']
text_normalized2entities_from_lookup(input,\
	entity_list)
'''
def text_normalized2entities_from_lookup(text_normalized,\
	entity_list,\
	entities = None):
...
text_normalized2text_entity_comb(input, 
	...
	'location':[{'entity':'dubai','method':'jessica1'}],\
...
text_normalized2text_entity_comb(\
	u" this is [ jessica liang ] and jessica smith liang xx cc jessica haha ",\
	entities = {'name':\
	['jessica smith liang xx cc jessica haha', 'smith liang xx', 'liang', 'jessica']},\
	indicator_re = '_name_')

from jessica_nlp_re import * 

text_normalized2text_entity_comb(\
	u" this is [ jessica liang ] and jessica smith liang xx cc jessica haha xx liang ",\
	entities = {'name':\
	['jessica smith liang xx cc jessica haha', 'smith liang xx', 'liang', 'jessica'],\
	'title':['liang']},\
...
o = text_normalized2text_entity_comb(\
	u" hi my name is jessica liang ",\
	entities = {'name':['jessica smith liang xx cc jessica haha', 'smith liang xx', 'liang', 'jessica'],\
	'title':['liang']},\
...
'''
input = u' _start_ this is jessica from abu dhabi , i live in dubai hi sam liang _start_ '

entities = {\
	'name':['jessica', 'sam', 'liang', 'sam liang'],\
...
text_normalized2text_entity_wild(\
	u" this is jessica jessica liang ",\
	entities = {'name':['jessica', 'liang', 'jessica liang']},\
	wild_entities = ['name'])
'''
def text_normalized2text_entity_wild(input, 
	entities = None,\
	wild_entities = None):
	#replace the sub entities by wildcards
	matched_entities = {}
...
'''
input = u" _start_ hi jessica i am jessica liang ' s brother , john . _end_ "
entities = {"name":["jessica","john","jessica liang"],"title":["brother"]}
target_entity = 'name'
...
'''
from jessica_nlp_re import *
input = ' _start_ jessica is my father and yan is my mother , we live in abu dhabi _end_ '
entities = {'name':['jessica','yan'], 'title':['father','mother'],'location':['abu dhabi']}
subject_entity = 'name'
object_entity = 'title'
...
'''
text_entity_context = {"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"}
entities = {"title":["brother"],"name":["jessica","john liang"]}
...
subject_object_context_list = [{'object': 'father', 'context': ' _start_ jessica is my _object_ and _subject_ is my mother , we live in abu dhabi _end_ ', 'subject': 'yan'}, {'object': 'mother', 'context': ' _start_ jessica is my father and _subject_ is my _object_ , we live in abu dhabi _end_ ', 'subject': 'yan'}, {'object': 'father', 'context': ' _start_ _subject_ is my _object_ and yan is my mother , we live in abu dhabi _end_ ', 'subject': 'jessica'}, {'object': 'mother', 'context': ' _start_ _subject_ is my father and yan is my _object_ , we live in abu dhabi _end_ ', 'subject': 'jessica'}]
entities = {'name':['jessica','yan'], 'title':['father','mother'],'location':['abu dhabi']}
...
'''
input = {'entity':'jessica','context':' _start_ my name is _entity_ how are you _location_ '}
...
'''
input = {'right_words': ['how', 'are', 'you', '_location_'], 'entity_words': ['jessica'], 'left_words': ['_start_', 'my', 'name', 'is']}
