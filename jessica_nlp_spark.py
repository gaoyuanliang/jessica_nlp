...
{"text":"i am from Abu Dhabi. come to build 8 in jessica house","text_normalized":" _start_ i am from abu dhabi . come to build 8 in jessica house _end_ ","url":[],"email":[],"number":["8"],"puntuation":["."],"name":["jessica"]}
...
def location_extraction(text, \
	...
	output += [{'entity': e, 'method':'jessica1'}\
		for e in outputs]
	###
	outputs = text_normalized2text_entity_comb(\
		text_normalized, \
	...
	output += [{'entity': e, 'method':'jessica2'}\
		for e in outputs]
	###
	return output
...
def from_location(text, \
	...
	output += [{'entity': e, 'method':'jessica3'}\
		for e in outputs]
	try:
...
def text_normalized_entity_extraction(\
	...
	output_df2.write.mode('Overwrite').json('%s/output_df2.json'%(workspace))
	output_df2 = sqlContext.read.json('%s/output_df2.json'%(workspace))
...
def sender_name_extract(text, \
	...
	output += [{'entity': e, 'method':'jessicai5'}\
		for e in outputs]
	return output

text = u"I am jessica's brother, John."
text_entity_context = {'context': \
	u" _start_ i am jessica ' s brother , _entity_ . _end_ ",\
	'enetity':'john'}
entities = {"name":["jessica","john"],"title":["brother"]}
...
sudo rm input.json
sudo vi input.json
i{"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","name":["jessica","john","john liang"],"title":["brother"]}
{"text":"this is a test","text_normalized":" _start_ this is a test _end_ ","name":[],"title":[]}
{"text":"My name is liang.","text_normalized":" _start_ my name is liang _end_ ","name":["liang"],"title":[]}
...
sudo rm input.json
sudo vi input.json
i{"text":"jessica is my father","text_normalized":" _start_ jessica is my father _end_ ","name":["jessica"],"role":["father"]}
...
sudo rm input.json
sudo vi input.json
i{"text":"My name is jessica","text_normalized":" _start_ my name is jessica _end_ ","name":["jessica"],"sender_married_indicator":[]}
{"text":"My name is Jane","text_normalized":" _start_ my wife name is jane _end_ ","name":["jane"],"sender_married_indicator":["my wife"]}
{"text":"My name is jessica","text_normalized":" _start_ my name is jessica _end_ ","name":["jessica"],"sender_married_indicator":[]}
{"text":"My name is jessica","text_normalized":" _start_ my name is jessica _end_ ","name":["jessica"],"sender_married_indicator":[]}
...
sudo rm input.json
sudo vi input.json
i{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am jessica ' s brother , _entity_ . _end_ ","entity":"john liang"},"sender_name_context":[{"method":"jessicai5","entity":"i am jessica ' s brother , _entity_"},{"method":"indicator: i am _name_ ' s _title_ , _entity_","entity":"i am jessica ' s brother , _entity_"}]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am jessica ' s brother , _entity_ liang . _end_ ","entity":"john"},"sender_name_context":[{"method":"jessicai5","entity":"i am jessica ' s brother , _entity_"},{"method":"indicator: i am _name_ ' s _title_ , _entity_","entity":"i am jessica ' s brother , _entity_"}]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"},"sender_name_context":[]}
{"name":["liang"],"text":"My name is liang.","text_normalized":" _start_ my name is liang _end_ ","title":[],"text_entity_context":{"context":" _start_ my name is _entity_ _end_ ","entity":"liang"},"sender_name_context":[{"method":"indicator: my name is _entity_","entity":"my name is _entity_"}]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"},"sender_name_context":[]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"},"sender_name_context":[]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"},"sender_name_context":[]}
{"name":["jessica","john","john liang"],"text":"I am jessica's brother, John.","text_normalized":" _start_ i am jessica ' s brother , john liang . _end_ ","title":["brother"],"text_entity_context":{"context":" _start_ i am _entity_ ' s brother , john liang . _end_ ","entity":"jessica"},"sender_name_context":[]}
...
sudo rm input.json
sudo vi input.json
i{"name":["jessica"],"role":["father"],"text":"jessica is my father","text_normalized":" _start_ jessica is my father _end_ ","entities":{"name":["jessica"],"role":["father"]},"text_subject_object_context":{"context":" _start_ _subject_ is my _object_ _end_ ","subject":"jessica","object":"father"},"subject_is_senders_object_context_indicator":[{"method":"jessica_subject_is_senders_object_190705_1","entity":"_subject_ is my _object_"}]}

prepare_subject_object_context_dl_input(\
	input_json = '/data/jessica/name_is_senders_role.json',\
	output_json = '/data/jessica/name_is_senders_role_train.json',\
...
hadoop fs -get /data/jessica/name_is_senders_role_train.json ./
...
("I am jessica", ["jessica"]),
("jessica is here", ["jessica"]),
("Hi jessica", ["jessica"]),
("My name is jessica and you?", ["jessica"]),
("I am a NLP scientist",[]),
("I work as an engineer, but also a researcher",[]),
("Hi, How are you?",[]),
("Hi, jessica, How are you?",[]),
("jessica is here",[]),
("jessica is not here, but jessica liang will com",[]),
], ["text", "indicator"]).write.mode('Overwrite').json('/raid/jessica/input.json')

input_json = '/raid/jessica/input.json'
output_json = '/raid/jessica/output.json'
indicator_column_name = 'indicator'

os.system(u"""
	rm -r /raid/jessica/temp6780
	mkdir /raid/jessica/temp6780
	""")
...
match_negatives_to_positives_from_json(
	...
	indicator_column_name = 'indicator',
	sqlContext = sqlContext,
	workspace = '/raid/jessica/temp6780',
...
sqlContext.createDataFrame([
("My name is jessica", "45678"),
("I am jessica", "45678"),
("jessica is here", "45678"),
("Hi jessica", "45678"),
("My name is jessica and you?", "45678"),
], ["text", "phone"]).write.mode('Overwrite').json('/raid/jessica/positives.json')

sqlContext.createDataFrame([
("I am a NLP scientist", "45678"),
("I work as an engineer, but also a researcher", "45678"),
("Hi, How are you?", "45678"),
("Hi, jessica, How are you?", "45678"),
("jessica is here", "45678"),
("jessica is not here, but jessica liang will com", "45678"),
], ["text", "phone"]).write.mode('Overwrite').json('/raid/jessica/database.json')

prepare_text_for_word_indexing(
	input_json = '/raid/jessica/positives.json',
	sqlContext = sqlContext,
	output_word_weight_json = '/raid/jessica/positive_word_weight.json',
	word_counting_unit = 'text',
	workspace = '/raid/jessica/temp6780')

prepare_text_for_word_indexing(
	input_json = '/raid/jessica/database.json',
	sqlContext = sqlContext,
	output_text_word_json = '/raid/jessica/text_word_weight.json',
	word_counting_unit = 'text',
	workspace = '/raid/jessica/temp6780').show(100)
'''
...
match_positive_words_to_text_json(
	input_word_json = '/raid/jessica/positive_word_weight.json',
	input_text_json = '/raid/jessica/text_word_weight.json',
	output_json = '/raid/jessica/recommended.json',
	sqlContext = sqlContext,
	recommended_text_num = 3,
	word_counting_unit = 'text',
	workspace = '/raid/jessica/temp6780').show()
'''
